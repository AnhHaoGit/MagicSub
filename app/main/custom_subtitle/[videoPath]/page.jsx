...
bg-[${customize.background_color}]`;
  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center p-3 sm:p-4 md:p-5 md:max-h-[200vh] lg:h-screen">
        <div className="flex flex-col lg:flex-row justify-between items-center w-full flex-1 gap-5 mt-20">
          <div className="flex flex-col h-full w-full lg:w-3/5 gap-5">
            <div className="flex items-center justify-center w-full bg-black rounded-2xl h-[250px] sm:h-[350px] md:h-[450px] lg:h-4/5">
          ...
          <div className="w-full lg:w-2/5 flex flex-col relative justify-evenly items-center h-auto lg:h-full gap-4 bg-smoke rounded-2xl p-4 sm:p-5">
            <div className="flex items-center justify-center absolute top-3 shadow-lg gap-3 sm:gap-5 bg-white p-2 rounded-4xl">
              <button
                onClick={handleTranscriptButton}
                className={`w-24 sm:w-30 py-2 rounded-4xl font-semibold text-sm sm:text-base transition-colors ${
                  isTranscript
