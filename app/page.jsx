    ...
    <>
      ...
      >
        ...
        {session && status === "authenticated" ? (
          <Link
            href="/main"
            className="flex gap-3 items-center bg-black text-white rounded-full py-3 px-6 sm:py-4 sm:px-12 lg:px-20 shadow-2xl mt-10 font-bold justify-center hover:bg-gray transition-colors text-md"
          >
            Go to App
          </Link>
        ) : (
